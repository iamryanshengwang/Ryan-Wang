...
- Served as the first author of the published paper titled "Research on Jing Dong’s self-built logistics based on TAM" in EMFRM 2022. 
...
你好，我是王运昇（Ryan），目前在圣路易斯华盛顿大学攻读硕士学位，本科毕业于深圳大学。

我的技术能力包括多种编程语言，C、C++、Python、Matlab和SQL，我能熟练运用Langchain、Streamlit、Blender 3D、Neo4j和SQLiteStudio等工具。

在联想公司担任算法工程师实习生期间，我构建了计算机组件的知识图谱，并结合大语言模型开发了基于Neo4j、Langchain和Streamlit的聊天机器人“Prometheus”。之前，在阳光保险集团担任数据分析师实习生时，我使用Python和Excel分析和管理数据。

我过去的项目经验包括在华盛顿大学医学院开发用于脑肿瘤检测的光线追踪软件，在中国人民大学通过数据挖掘分析互联网用户的行为，在深圳大学为地铁站开发基于人工智能的火灾检测系统。

我正在寻找算法工程师或软件工程师的工作机会，以下是我的简历。请联系我！

电话：13940832355 | 邮箱：iamryansheng@gmail.com | 地址：311 DeBaliviere Ave, St. Louis, MO
...
- 学士，信息与计算科学（2019年9月 - 2023年6月）

技术能力：

编程语言：C、C++、Python、Matlab、SQL

工具：TensorFlow、Simulink、Blender 3D、Neo4j、SQLiteStudio、LangChain
...
- 数据分析师实习生（2022年9月 - 2022年11月）

项目经历：

Prometheus聊天机器人：基于知识图谱结合大预言模型的计算机组件推荐系统

联想（2024年5月 - 至今）

- 使用Neo4j和py2neo构建计算机组件知识图谱，展示标签、所有权、评论和原始规则等细节。

- 结合大语言模型和知识图谱，通过Cypher语言处理用户输入，开发用于联想内部使用的聊天机器人。

光线追踪软件用于脑肿瘤检测与诊断

华盛顿大学医学院（2023年11月 - 2024年2月）

- 使用Matlab Simulink包开发光线追踪软件，改进CT和MRI图像中脑肿瘤位置预测。

- 实施前向光线追踪，根据超声波暂停方程确定肿瘤位置，通过反向光线追踪确保图像重建准确性。

使用数据挖掘分析互联网用户行为

中国人民大学（2022年6月 - 2022年9月）

- 使用SPSS和技术接受模型（TAM）收集和分析295份有效问卷，深入挖掘客户数据。

基于人工智能的地铁火灾检测系统

深圳大学（2019年11月 - 2020年6月）

- 开发基于机器学习的地铁站火灾检测系统，利用卷积神经网络（CNN）和真实火灾图像数据集。

- 创建火灾虚拟图像和视频，并贡献给项目测试数据集，提高模型的准确性。
